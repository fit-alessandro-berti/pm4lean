import Pm4Lean.Models.Petri.WFNet.WOFLAN.SoundnessViaShortCircuit.Obligations.Failure.Filtered.Cover.LengthNormalized.Failure.Sample

namespace Pm4Lean
namespace Petri

theorem exists_retained_noPredecessorGreedyCoordinate_not_dominated_of_not_noPredecessorGreedyCoordinateLengthNormalizedBasisCover
    {W : WFNet}
    (hNotCover :
