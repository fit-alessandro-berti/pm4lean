import Pm4Lean.Models.Petri.WFNet.WOFLAN.SoundnessViaShortCircuit.Obligations.Failure.Filtered.Cover.LengthNormalized.Failure.Extension.NotDominated

namespace Pm4Lean
namespace Petri

theorem exists_retained_noPredecessorGreedyCoordinate_greaterWitness_of_not_noPredecessorGreedyCoordinateLengthNormalizedBasisCover
    {W : WFNet}
    (hNotCover :
            ...
            FiringSequence.PrefixCutsCoveredBySamples samples ∧
              ∃ coords : List Nat,
                ...
                NatListBasisHasGreaterCoordinateWitness
                  coords coordinates :=
  exists_retained_noPredecessorGreedyCoordinate_greaterWitness_of_not_length_normalized_cover
