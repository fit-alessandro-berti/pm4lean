import Pm4Lean.Models.Petri.WFNet.WOFLAN.Boundedness.SelfCover.CutTrace.LargeMarkingThreshold.BadBound.Projection.Coordinates.Failure.NoPredecessor.Cover.Basis.Negation

namespace Pm4Lean
namespace Petri

theorem exists_retained_noPredecessorGreedyCoordinate_not_dominated_of_not_cover
    {W : WFNet}
    (hNotCover :
  ...
  (not_hasLargeCoveredPrefixCutNoPredecessorGreedyCoordinateBasisCover_iff.mp
